    ...
    <body>
        ...
        <table class="statistic-menu" border="0">
            ...
            <tr class="statistic-menu-head">
                ...
                <td class="statistic-menu-head-text" style="background: #57381B; border-radius: 20px;"><a class="statistic-menu-head-text" href="{{ route('income_week') }}">Week</a></td>     
                <td class="statistic-menu-head-text"><a class="statistic-menu-head-text" href="{{ route('income_month') }}">Month</a></td>
            </tr>
            <tr class="gap"></tr>
