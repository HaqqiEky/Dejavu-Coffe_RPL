    ...
    <body>
        ...
        <table class="statistic-menu" border="0">
            ...
            <tr class="statistic-menu-head">
                ...
                <td class="statistic-menu-head-text"><a class="statistic-menu-head-text" href="admin_statistic_week.php">Week</a></td>     
                <td class="statistic-menu-head-text" style="background: #57381B; border-radius: 20px;"><a class="statistic-menu-head-text" href="admin_statistic_month.php">Month</a></td>
            </tr>
            <tr class="gap"></tr>
        ...
        <table class="statistic-info">
            <tr>
                <th class="statistic-info-title" colspan="2">Total Ordered in a Month</th>
            </tr>
