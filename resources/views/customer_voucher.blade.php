...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <hr>
            <table class="voucher-table" cellspacing="10" border="0">
                <tr>
                    <td>
                        <table class="content-table" border="0">
                            <tr>
                                <td class="voucher-code">MYPJUNE66</td>
                                <td class="voucher-amount" rowspan="3">15% Off</td>
                            </tr>
                            <tr>
                                <td class="voucher-detail">minimum pembelian Rp50.000</td>
                            </tr>
                            <tr>
                                <td class="voucher-detail">maksimum potongan Rp15.000</td>
                            </tr>
                        </table>
                    </td>
                    <td>
