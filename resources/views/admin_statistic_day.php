    ...
    <body>
        ...
        <table class="statistic-menu" border="0">
            ...
            <tr class="statistic-menu-head">
                <td class="statistic-menu-head-text" style="background: #57381B; border-radius: 20px;"><a class="statistic-menu-head-text" href="admin_statistic_day.php">Day</a></td>           
        ...
        <table class="statistic-info">
            <tr>
                <th class="statistic-info-title" colspan="2">Total Ordered in a Day</th>
            </tr>
