...
<html lang="en">
    <head>
        ...
        <link href="/css/pembayaran_banktransfer_a.css" rel="stylesheet" />
    ...
    <body>
        ...
        <div class="container-2">
            <table class="metode-payment-box" border="0">
                ...
                <tr>
                    <td colspan="2"><div class="continue-shop-button"><div><a href="/Payment/Berhasil" class="continue-shop-text">Continue Shopping</a></div></div></td>
                </tr>
            </table>
            <table border="0">
                <tr>
                    <td><div class="warning-text">lakukan pembayaran sebelum pukul 15.06 atau pesanan Anda otomatis dibatalkan oleh sistem</div></td>
                </tr>
            </table>
        </div>
